...
# Docker equivalent
docker run -it --rm rag_evaluator -v /absolute/path/to/outputs:/app/rag_evaluator/outputs/ --input_file rag_evaluator/sample_input_file.xlsx --sheet_name "Sheet1" --use_search_api
```
